    ...
    var typeof_string = typeof "",
        ...
        generateSimpleCart = function (space) {
            ...
            simpleCart.extend({
                ...
                getGreenTaxName: function () {
                    return GREEN_TAX_NAME
                },
            ...
            simpleCart.extendCheckout({
                ...
                SendDatabase: function (opts) {
                    ...
                    // build basic form options
                    let data = {'green_tax': false, 'add_basket': false},
                        action = opts.url
                    ...
                    simpleCart.each(function (item, x) {
                        ...
                        if (item.get('name') === GREEN_TAX_NAME) {
                            data['green_tax'] = true
                        }
                        if (item.get('name') === ADD_BASKET_NAME) {
                            data['add_basket'] = true
                        }
                        elem['title'] = item.get('name');
                    ...
                    data['items'] = items
                    data['total'] = simpleCart.total()

                    $.ajax('https://cms.reitz.dev/items/m3_customer_data', {
